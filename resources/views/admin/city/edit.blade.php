...
@section('content')
    ...
    <form method="post" action="{{ route('admin.city.update', $data->id) }}" accept-charset="utf-8">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        <label>城市名称 <small class="text-red">*</small></label>
                    ...
                    <div class="form-group">
                        <label>父级城市<small class="text-red">*</small></label>
                        <div class="input-group">
                            <select data-placeholder="选择城市..." class="chosen-select" style="min-width:200px;" name="pid">
                                @if( $data->pid == 0)
                                    <option value="0" selected>顶级城市</option>
                                @endif
                                @foreach ($cities as $li)
                                    <option value="{{ $li->id }}" {{ (Input::old('pid', isset($data) ? $data->pid : null)  === $li->id) ? 'selected' : '' }}>{{ $li->name }}</option>
                ...
                <button type="submit" class="btn btn-primary">修改城市</button>
