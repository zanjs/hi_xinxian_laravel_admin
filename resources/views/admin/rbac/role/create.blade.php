...
@section('content')
    ...
    <form method="post" action="{{ route('rbac.role.store') }}" accept-charset="utf-8">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" autocomplete="off" value="{{ Input::old('name') }}" placeholder="角色标识">
                    </div>
                    <div class="form-group">
                        <label>显示名称 <small class="text-red">*</small></label>
                        <input type="text" class="form-control" name="display_name" autocomplete="off" value="{{ Input::old('display_name') }}" placeholder="显示名称">
                    </div>
                    <div class="form-group">
                        <label>角色说明 <small class="text-red">*</small></label>
                        <input type="text" class="form-control" name="description" autocomplete="off" value="{{ Input::old('description') }}" placeholder="说明">
                    </div>
