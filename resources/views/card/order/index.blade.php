...
@section('title') 订单管理 会员卡管理系统 @stop
{{-- 高亮显示 --}}
...
@section('content')
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($orders as $key => $li)
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('card.order.index') }}/{{ $li->id }}"><i class="fa fa-building-o" title="详情"></i></a>
    ...
    <form method="post" action="{{ route('card.order.index') }}" accept-charset="utf-8" id="hidden-delete-form">
...
@section('footer_js')
    <script type="text/javascript">
        ...
        $('.delete_item').click(function(){
            var action = '{{ route('card.order.index') }}';
            var id = $(this).data('id');
