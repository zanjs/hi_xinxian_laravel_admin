...
@section('title') 新增产品  会员卡管理系统 @stop
{{-- 高亮显示 --}}
...
@section('content')
    ...
    <form method="post" action="{{ route('card.product.store') }}" accept-charset="utf-8" style="position: relative" >
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="b_price" autocomplete="off" value="{{ Input::old('b_price') }}" placeholder="价格只能输入阿拉伯数字哦 如 19.8" required>
                    </div>
                    <div class="form-group">
                        <label>零售价格 <small class="text-red">*</small></label>
                        <input type="text" class="form-control" name="price" autocomplete="off" value="{{ Input::old('price') }}" placeholder="价格只能输入阿拉伯数字哦 如 19.8" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="number" autocomplete="off" value="{{ Input::old('number') }}" placeholder="" required>
                    </div>
