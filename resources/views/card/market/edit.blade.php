...
@section('title') 市场更新  会员卡管理系统 @stop
{{-- 高亮显示 --}}
...
@section('content')
    ...
    <form method="post" action="{{ route('card.market.update', $data->id) }}" accept-charset="utf-8">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no" autocomplete="off" value="{{ Input::old('no',isset($data) ? $data->no : null) }}" placeholder="" required>
                    </div>
                    <div class="form-group">
                        <label>市场地址 <small class="text-red">*</small></label>
                        <input type="text" class="form-control" name="address" autocomplete="off" value="{{ Input::old('address',isset($data) ? $data->address : null) }}" placeholder="" required>
                    </div>
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="radio" name="promotion" value="0" {{ ((isset($data) ? $data->promotion : 0) === 0) ? 'checked' : '' }}>
                            <label class="choice" for="radiogroup">否 &nbsp;&nbsp;</label>
                            <input type="radio" name="promotion" value="1" {{ ((isset($data) ? $data->promotion : 0) === 1) ? 'checked' : '' }} >
                            <label class="choice" for="radiogroup">是</label>
                        </div>
                    </div>
                </div><!-- /.tab-pane -->
