...
@section('title') 充值记录 会员卡管理系统 @stop
{{-- 高亮显示 --}}
...
@section('content')
    ...
    <form method="post" action="{{ route('card.recharge.index') }}" accept-charset="utf-8" id="hidden-delete-form">
...
@section('footer_js')
    <script type="text/javascript">
        ...
        $('.delete_item').click(function(){
            var action = '{{ route('card.recharge.index') }}';
            var id = $(this).data('id');
