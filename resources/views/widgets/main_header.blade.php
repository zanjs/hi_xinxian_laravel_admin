...
<header class="main-header">
    ...
    <a href="{{ route('admin.home') }}" class="logo">
        ...
        <span class="logo-lg"><b>Hi.Xin.Xian</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ Auth::user()->email }}
                                <small>{{ isset(Auth::user()->position) ? Auth::user()->position : "职位都不写" }}</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
                            ...
                            {{ isset(Auth::user()->description) ? Auth::user()->description : "简介都没有"}}
                        </li>
                        <!-- Menu Footer-->
