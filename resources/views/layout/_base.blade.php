...
<head>
    <meta charset="UTF-8">
    <title>@section('title') YouYa - YouYa @show{{-- 页面标题 --}}</title>
    <meta name="description" content="{{ isset($description) ? $description : 'YouYa Coding' }}" />
    <meta name="keywords" content="YouYa Coding,{{ Cache::get('website_keywords') }}" />
